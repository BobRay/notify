...
$_lang['mc_cssfile_desc'] = '(optional) Name of CSS file to use, or `` for no CSS file; default: notify.css. File should be in assets/notify/css/ directory';
...
$_lang['mc_parentid_desc'] = '(optional) Folder id where new documents are stored; default: Notify folder.';
