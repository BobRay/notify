...
$chunks[2]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nfsubscriberemail-fancytpl.chunk.html'));
...
$chunks[3]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nfnotifyformtpl.chunk.html'));
...
$chunks[4]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nftweettplexisting.chunk.html'));
...
$chunks[5]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nftweettplnew.chunk.html'));
...
$chunks[6]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nftweettplcustom.chunk.html'));
...
$chunks[7]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nfemailsubjecttpl.chunk.html'));
...
$chunks[8]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nfsubscriberemailtplexisting.chunk.html'));
...
$chunks[9]->setContent(file_get_contents($sources['source_core'] . '/elements/chunks/nfsubscriberemailtplnew.chunk.html'));
